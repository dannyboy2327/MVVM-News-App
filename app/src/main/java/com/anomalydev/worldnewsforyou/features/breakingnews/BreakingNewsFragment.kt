...
MainActivity.OnBottomNavigationFragmentReselectedListener{
    ...
    private var _currentBinding:  FragmentBreakingNewsBinding? = null
    private val binding get() = _currentBinding!!

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        _currentBinding = FragmentBreakingNewsBinding.bind(view)
        ...
        newsArticleListAdapter.stateRestorationPolicy = RecyclerView.Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY
